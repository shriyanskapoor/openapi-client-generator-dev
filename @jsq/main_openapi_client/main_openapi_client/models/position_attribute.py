...
class PositionAttribute(BaseModel):
    ...
    investment_entity_id: StrictInt
    investor_group_id: StrictInt
    __properties: ClassVar[List[str]] = ["id", "account_id", "investment_entity_id", "investor_group_id"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "investment_entity_id": obj.get("investment_entity_id"),
            "investor_group_id": obj.get("investor_group_id")
        })
        return _obj
