...
class ContactDetailsAttributesEmail(BaseModel):
    """
    Email of the contact
    """ # noqa: E501
    id: Optional[StrictInt] = Field(default=None, description="ID of the email")
    email_type: Optional[StrictInt] = Field(default=None, description="Type of the email")
    email_address: Optional[StrictStr] = Field(default=None, description="Email address")
    __properties: ClassVar[List[str]] = ["id", "email_type", "email_address"]
