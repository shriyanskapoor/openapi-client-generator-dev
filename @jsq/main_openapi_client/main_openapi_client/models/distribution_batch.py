...
class DistributionBatch(BaseModel):
    ...
    """ # noqa: E501
    id: StrictInt
    total_amount: Union[StrictFloat, StrictInt] = Field(description="Total amount distributed")
    arena_id: StrictInt = Field(description="Arena ID this distribution batch belongs to.")
    entity_id: StrictInt = Field(description="Entity ID this distribution batch belongs to.")
    description: StrictStr = Field(description="Description of the distribution batch.")
    __properties: ClassVar[List[str]] = ["id", "total_amount", "arena_id", "entity_id", "description"]
