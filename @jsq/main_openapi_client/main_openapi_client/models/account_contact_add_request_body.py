...
class AccountContactAddRequestBody(BaseModel):
    """
    account contact add input
    """ # noqa: E501
    metadata: Optional[Dict[str, Any]] = None
    request_payload: Optional[Dict[str, Any]] = None
    __properties: ClassVar[List[str]] = ["metadata", "request_payload"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.request_payload:
            _dict['request_payload'] = self.request_payload.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "request_payload": AccountContactAdd.from_dict(obj["request_payload"]) if obj.get("request_payload") is not None else None
        })
        return _obj
