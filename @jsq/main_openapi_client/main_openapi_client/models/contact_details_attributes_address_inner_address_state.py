...
class ContactDetailsAttributesAddressInnerAddressState(BaseModel):
    """
    ContactDetailsAttributesAddressInnerAddressState
    """ # noqa: E501
    object_id: Optional[StrictInt] = Field(default=None, description="ID of the state")
    object_name: Optional[StrictStr] = Field(default=None, description="Name of the state")
    object_type: Optional[StrictStr] = Field(default=None, description="Type of the state object")
    __properties: ClassVar[List[str]] = ["object_id", "object_name", "object_type"]
