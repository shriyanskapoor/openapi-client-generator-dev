...
class UpdatePaymentPrefOptions(BaseModel):
    """
    An object provided when updating (patch) payment prefs. Note: presently only supports verification_status.
    """ # noqa: E501
    verification_status: Optional[StrictStr] = Field(default=None, description="Verification status for the payment preference: verified, unverified or error.")
    __properties: ClassVar[List[str]] = ["verification_status"]
