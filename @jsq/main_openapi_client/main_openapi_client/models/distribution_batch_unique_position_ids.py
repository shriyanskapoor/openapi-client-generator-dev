...
class DistributionBatchUniquePositionIds(BaseModel):
    """
    List of unique position ids for distribution batch IDs
    """ # noqa: E501
    unique_position_ids: List[StrictInt]
    __properties: ClassVar[List[str]] = ["unique_position_ids"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "unique_position_ids": obj.get("unique_position_ids")
        })
        return _obj
