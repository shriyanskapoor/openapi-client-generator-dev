...
class BulkAccountContactUpdateRequestBody(BaseModel):
    """
    Bulk account contact update array input
    """ # noqa: E501
    metadata: Optional[Dict[str, Any]] = None
    request_payloads: Optional[List[BulkAccountContactUpdate]] = None
    __properties: ClassVar[List[str]] = ["metadata", "request_payloads"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "request_payloads": [BulkAccountContactUpdate.from_dict(_item) for _item in obj["request_payloads"]] if obj.get("request_payloads") is not None else None
        })
        return _obj
