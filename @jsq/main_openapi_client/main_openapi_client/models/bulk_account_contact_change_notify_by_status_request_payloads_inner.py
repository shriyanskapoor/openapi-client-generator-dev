...
class BulkAccountContactChangeNotifyByStatusRequestPayloadsInner(BaseModel):
    """
    ...
    new_contact_name: Optional[StrictStr] = None
    comment: StrictStr
    __properties: ClassVar[List[str]] = ["arena_id", "account_id", "contact_id", "new_contact_name", "comment"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if new_contact_name (nullable) is None
        # and model_fields_set contains the field
        if self.new_contact_name is None and "new_contact_name" in self.model_fields_set:
            _dict['new_contact_name'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "new_contact_name": obj.get("new_contact_name"),
