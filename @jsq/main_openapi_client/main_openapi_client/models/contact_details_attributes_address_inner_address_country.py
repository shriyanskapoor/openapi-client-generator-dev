...
class ContactDetailsAttributesAddressInnerAddressCountry(BaseModel):
    """
    ContactDetailsAttributesAddressInnerAddressCountry
    """ # noqa: E501
    object_id: Optional[StrictInt] = Field(default=None, description="ID of the country")
    object_name: Optional[StrictStr] = Field(default=None, description="Name of the country")
    object_type: Optional[StrictStr] = Field(default=None, description="Type of the country object")
