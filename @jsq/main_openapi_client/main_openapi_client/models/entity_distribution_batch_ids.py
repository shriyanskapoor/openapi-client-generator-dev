...
class EntityDistributionBatchIds(BaseModel):
    """
    The distribution batch IDs associated with an entity
    """ # noqa: E501
    entity_id: StrictInt
    distribution_batch_ids: List[StrictInt]
    __properties: ClassVar[List[str]] = ["entity_id", "distribution_batch_ids"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "distribution_batch_ids": obj.get("distribution_batch_ids")
        })
        return _obj
