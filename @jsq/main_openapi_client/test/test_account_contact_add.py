...
class TestAccountContactAdd(unittest.TestCase):
    """AccountContactAdd unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AccountContactAdd:
        """Test AccountContactAdd
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AccountContactAdd`
        """
        model = AccountContactAdd()
        if include_optional:
            return AccountContactAdd(
    ...
    def testAccountContactAdd(self):
        """Test AccountContactAdd"""
